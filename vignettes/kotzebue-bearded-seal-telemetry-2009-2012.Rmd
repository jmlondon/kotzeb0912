...
_National Marine Mammal Laboratory, Alaska Fisheries Science Center, NOAA, Seattle, WA, USA_
...
instr
  ~ An alphanumeric string that identifies the make/model class of the tag
    ...
    Mk10
      ~ Argos (and, optionally, fastloc-GPS) location tags with additional
        sensors for recording depth/dive behavior, temperature, conductivity.
        For this project, _Mk10_ tags were adhered to the hair of the seal
        on the head.
...
type
  ~ An character string that identifies whether the location estimate is
    based on the Argos process or the fastloc-GPS
