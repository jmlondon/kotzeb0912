---
title: "Telemetry dataset from satellite tags deployed on adult bearded seals in Kotzebue, Alaska"
...
abstract: >
  ...
  the Wildlife Computers Data Portal via their API. The data are provided as
  zipped archives for each deployment and are preserved as is. The archives
  are uploaded to the Arctic Data Center repository along with relevant
  metadata and provenance information. Fourteen tags were deployed on 7 adult 
  bearded seals that were captured and released near Kotzebue, Alaska, USA. 
output: 
  uswebr::html_uswds:
